...
QT_MOC_LITERAL(1, 13, 11), // "SendCommand"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 38), // "std::vector<std::shared_ptr<C..."
QT_MOC_LITERAL(4, 65, 8) // "commands"

    },
    "DiagramScene\0SendCommand\0\0"
...
void DiagramScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SendCommand((*reinterpret_cast< std::vector<std::shared_ptr<Command> >(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (DiagramScene::*_t)(std::vector<std::shared_ptr<Command>> );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DiagramScene::SendCommand)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DiagramScene::SendCommand(std::vector<std::shared_ptr<Command>> _t1)
{
