...
QT_MOC_LITERAL(1, 7, 12), // "SendCommands"
...
void Client::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Client::*_t)(std::vector<std::shared_ptr<Command>> );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Client::SendCommands)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Client::SendCommands(std::vector<std::shared_ptr<Command>> _t1)
{
